...
public class Product {
	...
	public void mostExpensiveProduct(Product product1, Product product2, Product product3, Product product4) {
		
		if ((product1.getPrice() > product2.getPrice()) && (product1.getPrice() > product3.getPrice())
				&& (product1.getPrice() > product4.getPrice())) {
			System.out.println("The most expensive product is " + product1.getName());
		} else if ((product2.getPrice() > product3.getPrice()) && product2.getPrice() > product4.getPrice()) {
			System.out.println("The most expensive product is " + product2.getName());
		} else if (product3.getPrice() > product4.getPrice()) {
			System.out.println("The most expensive product is " + product3.getName());
		} else {
